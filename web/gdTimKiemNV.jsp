...
<html>
    <head>
        ...
        <title>Tìm kiếm nhân viên vào ca làm</title>
    </head>
    <style>
        html{
    ...
    <body>
        <div class="insert">
            <header>
                <span class="main__title">Tìm kiếm nhân viên vào ca làm</span>
            </header>
            <div class="container">
                <div class="wrapper">
                    <span class="title" style="margin-bottom: 20px;">
                        <form method="POST" action="SearchNhanVien">
                            <div class="form__button" style="margin-right: 30px;"> 
                                <span style="font-size: 20px;">Nhập tên nhân viên :</span> 
