...
<html>
    ...
    <body>
        <div class="insert">
            <header>
                <span class="main__title">Lịch làm việc của nhân viên</span>
                
            </header>
            <span style="margin-left: 494px;">* Ghi chú : ${lichLV.ghiChu}</span>
            <div class="container">
                                ...
                                <tbody>
                                    ...
                                    <c:forEach var="thu" items="${listThu}">
                                        <tr>
                                            ...
                                            <td>
                                                <a style=" width: 273px">
                                                    <c:forEach var="lichDK" items="${lichLV.dsLichDangKy}">
